...
from .models import Messages, Metrix, Visitors, Search
...
class UserAdminForm(UserAdmin):
  ...
  list_display = ('first_name', 'last_name', 'last_login', 'username', 'email', 'is_active', 'is_superuser', 'is_staff')
...
admin.site.site_header = 'Usman Musa'
admin.site.site_title = 'Usman Musa'
admin.site.index_title = 'Usman Musa admin'
