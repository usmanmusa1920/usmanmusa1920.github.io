...
class MessageCls:
    ...
    @staticmethod
    def dm(request):
        """Direct message (DM) view"""
        
        context = {
            'general_context': general_context()
        }
        return render(request, 'account/dm.html', context)
    ...
    def send(request):
        ...
        if form.is_valid():
            ...
            subj = f'An email sent through personal website - {sender_name}'
            body = f'Hi! Usman,\n\n{text_body}\n\nSender details:\n\tName: {sender_name}\n\tEmail: {sender_email}'
            ...
            messages.success(request, format_html('Thanks<b>&nbsp;{}&nbsp;</b>for your message,&nbsp;<b>Usman</b>&nbsp;will response at the earliest.', sender_name))
            return redirect('auth:dm')
